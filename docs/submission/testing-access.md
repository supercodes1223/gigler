...
- For judging we have prepared an open sample: `{{SAMPLE_SHORTCODE}}` is a bills-split dashboard generated by the agent from a receipt photo texted into a group thread. OTP for this sample: `{{SAMPLE_OTP_OR_NOTE_IF_UNGATED}}`.
...
Public repository: **https://github.com/supercodes1223/gigler**
