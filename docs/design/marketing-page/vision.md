...
> What the new marketing page must communicate, who it converts, and how it should feel.
> This is the source of truth for every other doc in this folder.

## The product in one line

<!-- The single sentence a visitor should be able to repeat after 5 seconds on the page.
     Reference: assistant docs describe it as "a personal assistant you text, call, and
     email like a real person — and it actually gets your life done." -->
...
- Technical (no architecture, no model names, no infrastructure)
- Vague about what the product actually does
- A feature list without a story

## Notes

<!-- Freeform vision dump goes here -->
